...
// ─────────────────────────────────────────────
const dates = {
  dp203:       "2026-07-01", // Azure DP-203 cert target
...
export const bio = {
  ...
  summary:
    "Software engineer with a data engineering focus and ~5 years of experience building ETL pipelines, data models, and analytics solutions in Python and SQL. First Class Honours graduate in Business Intelligence and Analytics with hands-on delivery across healthcare, defence, and AI domains. Currently deepening expertise in cloud data infrastructure and modern data stack tooling.",
...
// ─────────────────────────────────────────────
// CERTIFICATIONS
// DP-203 appears after dates.dp203
...
export const skills = {
  ...
  "in progress": [
    ...(!isAfter(dates.dp203)      ? ["Azure (DP-203)"] : []),
    "Apache Airflow",
    "dbt",
    "PySpark",
