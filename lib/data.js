...
export const projects = [
  ...
  },
  {
    title: "lexio",
    description:
      "Full-stack language learning application with a FastAPI backend, JWT authentication, and relational data modelling via SQLAlchemy. Features an idempotent CSV/Anki import pipeline, SM-2 spaced repetition, AI essay feedback, CJK text mining, and translation/TTS integration.",
    tech: ["Python", "FastAPI", "SQLAlchemy", "PostgreSQL", "SQLite", "JavaScript"],
